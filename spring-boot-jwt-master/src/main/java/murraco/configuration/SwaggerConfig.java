...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)//
                ...
                .tags(new Tag("block", "Add/Get/Update/Delete Block"))
                .tags(new Tag("course", "Add/Get/Update/Delete Course"))
                .tags(new Tag("entry", "Add/Get/Update/Delete Entry"))
                .tags(new Tag("offering", "Add/Get/Update/Delete Offering"))
